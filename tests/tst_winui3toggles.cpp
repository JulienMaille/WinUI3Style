...
void WinUI3TogglesTest::toggleDragInteraction()
{
    ...
    QMouseEvent move(QEvent::MouseMove, QPointF(32, 20), QPointF(32, 20), Qt::NoButton,
    ...
    QMouseEvent release(QEvent::MouseButtonRelease, QPointF(32, 20), QPointF(32, 20),
...
void WinUI3TogglesTest::toggleRtlGeometryAndInteraction()
{
    ...
    QMouseEvent move(QEvent::MouseMove, QPointF(onKnob), QPointF(onKnob), Qt::NoButton,
                     Qt::LeftButton, Qt::NoModifier);
    QCoreApplication::sendEvent(&toggle, &move);
    QVERIFY(frameBool(&toggle, "_winui_toggle_dragging"));
    QMouseEvent release(QEvent::MouseButtonRelease, QPointF(onKnob), QPointF(onKnob),
                        Qt::LeftButton, Qt::NoButton, Qt::NoModifier);
    QCoreApplication::sendEvent(&toggle, &release);
    QVERIFY(toggle.isChecked());
    QVERIFY(!frameBool(&toggle, "_winui_toggle_dragging"));
